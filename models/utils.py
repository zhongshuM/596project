...
def display2Dseg(img, depth, segs_pred, segs_gt, label, iters, method=9, draw_gt=0):
    ...
    cv2.imwrite(f'results/{iters}_depth.png', depth * 255)
    cv2.imwrite(f'results/{iters}_orign.png', img * 255)
    #pcl_path = f'results/{iters}_polys.pcd'
    #pclpy.pcl.io.savePCDFile(pcl_path, *polys)
    #print()
    #print(pcl_path)
    #print()
    if draw_gt > 0:
